...
- Found in src/staking/RewardsDistributor.sol [Line: 129](src/staking/RewardsDistributor.sol#L129)
...
- Found in src/staking/RewardsDistributor.sol [Line: 142](src/staking/RewardsDistributor.sol#L142)

	```solidity
	    function notifyReward(uint256 amount) external nonReentrant onlyRole(REWARDS_NOTIFIER_ROLE) whenNotPaused {
	```

- Found in src/staking/RewardsDistributor.sol [Line: 154](src/staking/RewardsDistributor.sol#L154)

	```solidity
	    function addPendingPenalty(uint256 amount) external nonReentrant onlyRole(REWARDS_NOTIFIER_ROLE) whenNotPaused {
	```

- Found in src/staking/RewardsDistributor.sol [Line: 172](src/staking/RewardsDistributor.sol#L172)

	```solidity
	    function pause() external onlyRole(PAUSER_ROLE) {
	```

- Found in src/staking/RewardsDistributor.sol [Line: 177](src/staking/RewardsDistributor.sol#L177)
...
- Found in src/staking/Staking.sol [Line: 312](src/staking/Staking.sol#L312)

	```solidity
	    function pause() external onlyRole(PAUSER_ROLE) {
	```

- Found in src/staking/Staking.sol [Line: 317](src/staking/Staking.sol#L317)
...
- Found in src/staking/Staking.sol [Line: 278](src/staking/Staking.sol#L278)
